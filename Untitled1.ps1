...
# Write-Host $DestinationSharepointSite
...
# $destinationOneDrivePath = "/personal/$DestinationSiteFormatted/Documents/$($departingOwner.Title)'s Files"
$destinationOneDrivePath = "/sites/$DestinationSiteFormatted/Documents/$($departingOwner.Title)'s Files"
$DestinationSharepointSiteRelativePath = "Documents/$($departingOwner.Title)'s Files"
